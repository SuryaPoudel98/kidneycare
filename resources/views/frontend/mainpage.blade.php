    ...
    <section class="inner-banner py-5">
        <div class="w3l-breadcrumb py-lg-5">
            <div class="container pt-4 pb-sm-4">
                <h4 class="inner-text-title font-weight-bold pt-sm-5 pt-4">{{ $ParentContentDetails[0]->parentpage->title ?? ''}}</h4>

                <ul class="breadcrumbs-custom-path">
                    <li><a href="/">Home</a></li>
                    <li class="active"><i class="fas fa-angle-right mx-2"></i>{{ $ParentContentDetails[0]->parentpage->title  ?? ''}}</li>
                </ul>
            </div>
        </div>
    </section>
