...
<div>
    <div class="grid-form1">
        ...
        @endif
        <form class="form-horizontal" action="{{ route('childcontent.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-2 text-right">
                        <label for="child page">Child page:</label>
                    </div>
                    <div class="col-sm-10">
                        <select name="childpage_id" id="childpage_id" class="form-select form-select-sm" value="{{ $childcontent->childpage_id }}">
                            ...
                            <option value="{{ $childpage->id }}" {{ $childpage->childpage_id == $childpage->id ? 'selected' : '' }}> {{ $childpage->child_title }} </option>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input style="margin-top: 10px;" type="file" onclick="previewFile(this)" name="thumbnailimg" placeholder="image">
